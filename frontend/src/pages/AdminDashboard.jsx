...
function AdminDashboard() {
  ...
  const handleSubmitNotice = async (e) => {
    ...
    if (!noticeForm.eventName || !noticeForm.rulesAndRegulations || !noticeForm.notifications) {
  ...
  const handleEditNotice = (notice) => {
    ...
    setNoticeForm({
      ...
      rulesAndRegulations: notice.rulesAndRegulations,
          ...
          {showNoticeForm && (
            <form className="notice-form" onSubmit={handleSubmitNotice}>
              <div className="form-group">
                ...
                <input
                  type="text"
                  value={noticeForm.eventName}
                  onChange={(e) => setNoticeForm({...noticeForm, eventName: e.target.value})}
              ...
              <div className="form-group">
                ...
                <textarea
                  value={noticeForm.rulesAndRegulations}
                  onChange={(e) => setNoticeForm({...noticeForm, rulesAndRegulations: e.target.value})}
              ...
              <div className="form-group">
                ...
                <textarea
                  value={noticeForm.notifications}
                  onChange={(e) => setNoticeForm({...noticeForm, notifications: e.target.value})}
